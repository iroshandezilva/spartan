 ...
 */
import { clampToSrgbGamut, formatOklch, isInSrgbGamut } from "./oklch.js";
/** The scale steps, lightest to darkest. Shared by every family. */
export const SCALE_STEPS = [0, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950, 1000];
/**
 ...
 */
export function generateScale(seed) {
...
export function generateFamilies(seeds) {
